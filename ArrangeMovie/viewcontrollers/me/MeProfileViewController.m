...
-(void)viewDidLoad {
    ...
    [self.editHeadImageView setShadowWithType:EMIShadowPathRound shadowColor:[UIColor blackColor] shadowOffset:CGSizeMake(0, 0) shadowOpacity:0.5 shadowRadius:10 image:@"" placeholder:@"profile_revision"];
