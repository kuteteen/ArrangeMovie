//
//  ManagerDeleteTaskWebInterface.m
//  ArrangeMovie
//
//  Created by 陈凯 on 16/12/9.
//  Copyright © 2016年 EMI. All rights reserved.
//

#import "ManagerDeleteTaskWebInterface.h"

@implementation ManagerDeleteTaskWebInterface
-(instancetype)init {
    self = [super init];
    if(self){
        self.url = [NSString stringWithFormat:@"%@%@",self.server,@"deleteTaskRecive.do"];
    }
    return self;
}
