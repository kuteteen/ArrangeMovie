...
#import "LoginAuthWebInterface.h"

@implementation LoginAuthWebInterface
-(instancetype)init {
    self = [super init];
    if(self){
...
-(NSDictionary *)inboxObject:(id)param {
    ...
    if(array.count>0){
        ...
        @try {
            ...
            [dict setObject:array[1] forKey:@"imgtype"];//传0就可以了,院线认证
            [dict setObject:array[2] forKey:@"imgs"];
