...
@implementation SCFadeSlideView
...
- (void)refreshVisibleCellAppearance{
    ...
    switch (self.orientation) {
        case SCFadeSlideViewOrientationHorizontal:{
            ...
            int location = (int)self.visibleRange.location;
            for (int i = location; i < self.visibleRange.location + _visibleRange.length; i++) {
...
- (UIView *)dequeueReusableCell{
    SCSlidePageView *cell = [_reusableCells lastObject];
    if (cell)
    {
